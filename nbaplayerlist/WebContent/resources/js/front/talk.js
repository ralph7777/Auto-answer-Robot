...
$(function(){
	render();
	var content = "Welcome!<br/>Please enter something about your favourite player.";
	content += "<br/>Enter [players] to see all players in system.";
//	var content = "Welcome!<br/>Please enter something about your favourite team.";
//	content += "<br/>Enter [teams] to see all teams in system.";
	// Introduction
